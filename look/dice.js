...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-d8181ad3');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-d8181ad3');}
...
function clearFlash(){dieView.classList.remove('rl-win-d8181ad3');dieView.classList.remove('rl-lose-d8181ad3');if(frameEl){frameEl.classList.remove('rl-win-d8181ad3');frameEl.classList.remove('rl-lose-d8181ad3');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-d8181ad3');if(frameEl){frameEl.classList.add('rl-win-d8181ad3');}}else{dieView.classList.add('rl-lose-d8181ad3');if(frameEl){frameEl.classList.add('rl-lose-d8181ad3');}}
...
var brandEl=document.querySelector('.rl-brand-d8181ad3');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
